...
class CheckStaffAuthorization extends StatefulWidget {
  @override
  _CheckStaffAuthorizationState createState() =>
      _CheckStaffAuthorizationState();
}
    ...
    return StreamBuilder<Authorizations>(
        ...
        builder: (context, snapshot) {
          ...
          if (snapshot.hasData) {
            ...
            if (authorizations.authorizedRoles![database.userId] ==
                    ROLE_STAFF ||
                authorizations.authorizedRoles![database.userId] ==
                    ROLE_VENUE) {
              session.userDetails!.role =
                  authorizations.authorizedRoles![database.userId];
              return MessagesListener(
                child: RestaurantAdministratorPage(),
              );
            }
          }
