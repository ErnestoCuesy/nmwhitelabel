...
class OptionObservableStream {
  ...
  Stream<List<Option>> get stream => _subject.stream.transform(streamTransformer);

  var streamTransformer = StreamTransformer<Map<String?, dynamic>?, List<Option>>.fromHandlers(
    handleData: (Map<String?, dynamic>? data, EventSink<List<Option>> sink) {
